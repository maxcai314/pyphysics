...
from casadi import *
from mpc_drive_simulator import *
from mpc_with_forces import N, nin, nstate, frequency
from forcespro.nlp.solver import Solver

m = Solver.from_directory("mecanum_mpc").solve
def run_solver(
        target_position,
        battery_voltage=12,
    ...
    output_dict, exitflag, info = m(problem)
