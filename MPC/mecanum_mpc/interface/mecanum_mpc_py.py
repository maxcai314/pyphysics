...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.1
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - matrix of size [250x1]
       PARAMS['xinit'] - matrix of size [6x1]
       PARAMS['all_parameters'] - matrix of size [525x1]
...
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 250),
('xinit', ctypes.c_double * 6),
('all_parameters', ctypes.c_double * 525),
]
...
('x11', ctypes.c_double * 10),
('x12', ctypes.c_double * 10),
('x13', ctypes.c_double * 10),
('x14', ctypes.c_double * 10),
('x15', ctypes.c_double * 10),
('x16', ctypes.c_double * 10),
('x17', ctypes.c_double * 10),
('x18', ctypes.c_double * 10),
('x19', ctypes.c_double * 10),
('x20', ctypes.c_double * 10),
('x21', ctypes.c_double * 10),
('x22', ctypes.c_double * 10),
('x23', ctypes.c_double * 10),
('x24', ctypes.c_double * 10),
('x25', ctypes.c_double * 10),
]
