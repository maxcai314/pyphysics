...
classdef mecanum_mpcBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output,exitflag,info] = forcesInitOutputsMatlab()
            ...
            outputs_x11 = coder.nullcopy(zeros(10, 1));
            outputs_x12 = coder.nullcopy(zeros(10, 1));
            outputs_x13 = coder.nullcopy(zeros(10, 1));
            outputs_x14 = coder.nullcopy(zeros(10, 1));
            outputs_x15 = coder.nullcopy(zeros(10, 1));
            outputs_x16 = coder.nullcopy(zeros(10, 1));
            outputs_x17 = coder.nullcopy(zeros(10, 1));
            outputs_x18 = coder.nullcopy(zeros(10, 1));
            outputs_x19 = coder.nullcopy(zeros(10, 1));
            outputs_x20 = coder.nullcopy(zeros(10, 1));
            outputs_x21 = coder.nullcopy(zeros(10, 1));
            outputs_x22 = coder.nullcopy(zeros(10, 1));
            outputs_x23 = coder.nullcopy(zeros(10, 1));
            outputs_x24 = coder.nullcopy(zeros(10, 1));
            outputs_x25 = coder.nullcopy(zeros(10, 1));
    ...
    methods (Static, Access = private)
        function [output,exitflag,info] = forcesInitOutputsC()
            ...
            outputs_x11 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x12 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x13 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x14 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x15 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x16 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x17 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x18 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x19 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x20 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x21 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x22 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x23 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x24 = coder.nullcopy(double(zeros(10, 1)));
            outputs_x25 = coder.nullcopy(double(zeros(10, 1)));
            output = struct('x01', outputs_x01,...
                            'x02', outputs_x02,...
                            'x03', outputs_x03,...
                            'x04', outputs_x04,...
